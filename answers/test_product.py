...
class TestProduct:
    ...
    @pytest.fixture
    def test_methods_to_test(self):
        return [
            self.product.get_products,
            self.product.get_highly_rated
        ]
    ...
    @pytest.mark.parametrize('api_results', [
        mocked_api_result,
        [
    ...
    @pytest.mark.parametrize('methods', test_methods_to_test)
    def test_method_performance(self, benchmark, methods):
        benchmark(methods)
